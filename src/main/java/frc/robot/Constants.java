...
public final class Constants {
	...
	public class SwerveConstants {
		...
		public static final double driveBaseWidth = 29.5;
		/** Distance between the 2 front side CANcoders */
		public static final double driveBaseHeight = 29.5;
	...
	public static final class AutoConstants {
		...
		/* TODO: Fix all these pid constants */
		// public static final PIDConstants translationPID = new PIDConstants(15, 0.2,
		// 0.2);
		public static final PIDConstants translationPID = new PIDConstants(5, 20, 0, 7);
		...
		/* Best so far */
		public static final PIDConstants rotationPID = new PIDConstants(1.57, 0.07, -0.1, 1);
		...
		/* TODO: Look into this (profiled pid controllers/constraints) */
		ProfiledPIDController mThetaController = new ProfiledPIDController(kPThetaController, 0, 0,
